### Setting the timezone for the shell to be London
### Documented here:
...
alias aprint='a2ps -s2 -Ma4 -Ppsprint'
alias cd..='cd ..'
alias cp='cp -i'
alias dig='dig +short'
alias ll='ls -lFG'
...
alias pca='perl -pi -e '\''s/\r\n?/\n/g'\'''
alias rm='rm -i'
alias tails='tail -f /var/log/system.log'
alias tarc='tar -zvcf'
alias tarx='tar xzvf'
...
export PS1="$GREEN\u$WHITE_BOLD@$YELLOW\h:$WHITE\w $RED_BOLD> \[\e[0m\]"

# two -liner with time:
export PS1="$CYAN_BOLD\t $GREEN\u$WHITE_BOLD@$YELLOW\h:$WHITE\w
$RED_BOLD> \[\e[0m\]"

# MacPorts Installer addition on 2015-12-23_at_13:38:16: adding an appropriate PATH variable for use with MacPorts.
export PATH="/opt/local/bin:/opt/local/sbin:$PATH"
# Finished adapting your PATH environment variable for use with MacPorts.

# MacPorts Installer addition on 2015-12-25_at_14:29:35: adding an appropriate PATH variable for use with MacPorts.
export PATH="/opt/local/bin:/opt/local/sbin:$PATH"
# Finished adapting your PATH environment variable for use with MacPorts.

# on dark backgrounds the default colour of folders when ls are too dark. changing the di value to 01;94 did the trick
# more info here: https://linuxhint.com/ls_colors_bash/
